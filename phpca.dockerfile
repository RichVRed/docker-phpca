# BUILD:
# docker build --force-rm --tag "rvannauker/phpca:latest" --file phpca.dockerfile .
# RUN:
# docker run --rm --volume $(pwd):/workspace --name="phpca" "rvannauker/phpca:latest" --no-progress {destination}
